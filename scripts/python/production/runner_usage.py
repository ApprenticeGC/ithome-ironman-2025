...
def get_billing_data():
    ...
    # Use fine-grained token with Plan permissions for user billing
...
def main() -> int:
    ...
    if not token or not owner or not repo:
        ...
        print("For billing API access, the token needs 'Plan' permissions for user billing endpoints.", file=sys.stderr)
        return 2
